...
import Images from "../components/PrevImagesCarousel";
import PrevImagesCarousel from "../components/PrevImagesCarousel";
import NextImagesCarousel from "../components/NextImagesCarousel";
    ...
    <div>
      ...
      <div className="flex justify-center  items-center bg- ">
        <div className="flex justify-center  mt-8 min-w-full">
          <div className="flex p-2 text-white w-[80%] flex-col overflow-hidden  bg-color border rounded-sm border-pink-700 max-w-[90%]">
            ...
            <div className="flex flex-col rounded protocol-fields mt-2  py-2 px-1  bg-secondary">
            ...
            <div className="bg-secondary protocol-fields rounded mt-2  py-2 px-1">
            ...
            <div className="flex flex-col mt-2 rounded bg-secondary py-2 px-1">
              <div className="protocol-fields cursive text-xl p-1 pb-2">
                Pictures:
                <div className="flex mt-4 p-4 justify-around flex-wrap">
                  <div className="w-1/3">
                    <p></p>
                    <PrevImagesCarousel />
                  </div>
            ...
            <div className="flex flex-col mt-2 rounded bg-color py-2 px-1">
              <div className="protocol-fields cursive text-xl p-1 pb-2">
                Description:
              </div>
              <div className="p-2">{protocol?.description}</div>
